...
GAME_O_LIBNETHACK = allmain.o apply.o artifact.o attrib.o ball.o bones.o botl.o cmd.o    \
                    ...
                    lock.o log.o makemon.o memfile.o messages.o mhitm.o mhitq.o          \
...
nhfourk: $(GAME_O) libuncursed/src/plugins/tty.c libuncursed/src/plugins/tty.cxx 
...
clean::
	rm -f nhfourk libnethack/util/makedefs
	rm -f $(ALL_O)
...
clean::
	rm -f libnethack/include/artinames.h libnethack/include/onames.h libnethack/include/pm.h libnethack/src/readonly.c libnethack/include/date.h libnethack/include/verinfo.h
